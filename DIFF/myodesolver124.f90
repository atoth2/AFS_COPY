...
real, dimension(1:neq) :: yic=(/4.248/) !set the initial conditions ! Changed !!!!
...
ydot(1) = 40*y(1)*(1-lambda*y(1)) ! Changed !!!!!!!!!!!!!!!!!
end subroutine fcn
end module rhs
!
!-------------------------------------------------------------------------
...
call ode4(y,t,tout) !update y and t ! Changed !!!!!!!!!!!!!!!!!
print*,t,y !output the results
write(10,*)t,y
enddo
print*,'error = ',y(1) - 1./(1.+exp(-40.*t)),dt  ! Changed !!!!!!!!!!!!!!!!!
